    ...
    export class UI_Tree {
        constructor() {
            ...
            var res: Array<string> = [
                "../laya/res/ui/vscroll.png",
                "../laya/res/ui/vscroll$bar.png",
                "../laya/res/ui/vscroll$down.png",
                "../laya/res/ui/vscroll$up.png",
                "../laya/res/ui/tree/clip_selectBox.png",
                "../laya/res/ui/tree/clip_tree_folder.png",
                "../laya/res/ui/tree/clip_tree_arrow.png"
            ];
        ...
        private onLoadComplete(): void {
            ...
            tree.scrollBarSkin = "../laya/res/ui/vscroll.png";
...
class Item extends Box {
    constructor() {
        ...
        var selectBox: Clip = new Clip("../laya/res/ui/tree/clip_selectBox.png", 1, 2);
        ...
        var folder: Clip = new Clip("../laya/res/ui/tree/clip_tree_folder.png", 1, 3);
        ...
        var arrow: Clip = new Clip("../laya/res/ui/tree/clip_tree_arrow.png", 1, 2);
