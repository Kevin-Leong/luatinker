...
//             var characterA: Sprite = this.createCharacter("../laya/res/cartoonCharacters/1.png");
//             characterA.pivot(46.5, 50);
//             characterA.y = 100;

//             var characterB: Sprite = this.createCharacter("../laya/res/cartoonCharacters/2.png");
