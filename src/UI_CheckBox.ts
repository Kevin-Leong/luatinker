...
//             this.skins = ["../laya/res/ui/checkbox (1).png", "../laya/res/ui/checkbox (2).png", "../laya/res/ui/checkbox (3).png", "../laya/res/ui/checkbox (4).png", "../laya/res/ui/checkbox (5).png", "../laya/res/ui/checkbox (6).png"];
