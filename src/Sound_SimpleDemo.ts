...
//             console.log("播放音乐");
//             SoundManager.playMusic("../laya/res/sounds/bgm.mp3", 1, new Handler(this, this.onComplete));
//         }

//         private onPlaySound(e: Event): void {
//             console.log("播放音效");
//             SoundManager.playSound("../laya/res/sounds/btn.mp3", 1, new Handler(this, this.onComplete));
//         }
