...
//             Laya.loader.load(["../laya/res/ui/progressBar.png", "../laya/res/ui/progressBar$bar.png"], Handler.create(this, this.onLoadComplete));
//         }

//         private onLoadComplete(): void {
//             this.progressBar = new ProgressBar("../laya/res/ui/progressBar.png");
