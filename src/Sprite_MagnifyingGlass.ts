...
// 			Laya.loader.load("../laya/res/bg2.png", Handler.create(this, this.setup));
// 		}

// 		private setup():void
// 		{
// 			var bg:Sprite = new Sprite();
// 			bg.loadImage("../laya/res/bg2.png");
// 			Laya.stage.addChild(bg);

// 			this.bg2 = new Sprite();
// 			this.bg2.loadImage("../laya/res/bg2.png");
// 			Laya.stage.addChild(this.bg2);
// 			this.bg2.scale(3, 3);
			
// 			//创建mask
// 			this.maskSp = new Sprite();
// 			this.maskSp.loadImage("../laya/res/mask.png");
